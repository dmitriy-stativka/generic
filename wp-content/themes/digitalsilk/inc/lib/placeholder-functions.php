...
if (!class_exists( 'woocommerce' ) && !is_admin()) {
    ...
    function is_product_category($cat=''){return false;}
    function wc_get_product($the_product = false, $deprecated = array()){return false;}
    function wc_coupons_enabled(){return false;}
    function wc_get_cart_url(){return false;}
    function wc_placeholder_img_src($size = ''){return false;}
